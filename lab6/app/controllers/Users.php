...
class Users extends Controller
{
    ...
    public function register()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($data['firstName_error']) && empty($data['lastName_error']) && empty($data['email_error']) &&  empty($data['password_error']) && empty($data['confirmPassword_error'])) {
                // Hashing password
    ...
    public function portal()
    {
        ...
        $apis = $this->userModel->userApis(Session::get('user_id'));

        if ($user) {
            $this->view('users/portal', $user, $apis);
        } else {
            die('sorry');
        }
